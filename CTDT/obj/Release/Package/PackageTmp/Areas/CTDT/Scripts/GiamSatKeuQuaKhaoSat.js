...
function LoadChartFullSurvey() {
    var year = $("#yearGiamSat").val();
    $.ajax({
        url: '/CTDT/GiamSatKetQuaKhaoSat/ChartsTyLeThamGiaKhaoSat',
        type: 'GET',
        data: { year: year },
...
function LoadChartSurveyThongTu01() {
    var year = $("#yearGiamSat").val();
    $.ajax({
        url: '/CTDT/GiamSatKetQuaKhaoSat/ChartsTyLeThamGiaKhaoSatThongTu01',
        type: 'GET',
        data: { year: year },
        success: function (res) {
