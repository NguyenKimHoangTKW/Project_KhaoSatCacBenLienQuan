    ...
    public class ThongKeKhaoSatController : Controller
    {
        ...
        public ActionResult load_charts_nguoi_hoc(int year = 0)
        {
            ...
            foreach (var survey in query)
            {
                ...
                if (!string.IsNullOrEmpty(idphieu.key_class))
                {
                    ...
                    {
                        sinh_vien_subject(ChartSurvey, user.id_ctdt, idphieu.surveyID, user.ctdt.ten_ctdt, keyClassList);
                    }
                }
                else
                {
        ...
        public async Task<JsonResult> load_tan_xuat(int surveyid = 0)
        {
            ...
            if (!string.IsNullOrEmpty(survey?.key_class))
            {
                ...
                {
                    sinh_vien_subject(ty_le_khao_sat, user.id_ctdt, survey.surveyID, user.ctdt.ten_ctdt, keyClassList);
                }
        ...
        private void sinh_vien_subject(dynamic ChartSurvey, int? idctdt, int? surveyid, string tenctdt, List<string> keyClassList)
        {
