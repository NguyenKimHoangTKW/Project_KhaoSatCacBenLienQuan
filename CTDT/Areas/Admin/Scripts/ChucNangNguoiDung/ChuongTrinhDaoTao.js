        ...
        res.data.forEach((item, index) => {
            html +=
                ...
                <tr>
                    ...
                    <td>
                        <button class="btn btn-primary btn-sm" id="btnEdit" data-id="${item.id_ctdt}">Sửa</button>
                        <button class="btn btn-danger btn-sm" id="btnDelete" data-id="${item.id_ctdt}">Xóa</button>
                    </td>
                </tr>
                `;
        });
